...
namespace FoodCalculator
{
    class Database
    {
        ...
        public bool registration(string name, string password, int gender, float weight, float height, int age)
        {
            ...
            MySqlCommand command = new MySqlCommand("INSERT INTO `users` (`name`, `password`, `gender`, `weight`, `height`, `age`) VALUES (@name, @password, @gender, @weigth, @height, @age)", this.getConnection());
